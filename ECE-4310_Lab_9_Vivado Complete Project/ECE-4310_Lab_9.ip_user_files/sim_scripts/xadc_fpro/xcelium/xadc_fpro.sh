...
#
# Script generated by Vivado on Sun Nov 03 03:06:19 PST 2024
...
#
# Usage        : xadc_fpro.sh
#                xadc_fpro.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xadc_fpro.sh [-reset_run]
#                xadc_fpro.sh [-reset_log]
#                xadc_fpro.sh [-help]
#
...
#                script (type 'xadc_fpro.sh -help' for more information).
#
...
# script info
echo -e "xadc_fpro.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xadc_fpro.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.xadc_fpro xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.xadc_fpro -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log xadc_fpro_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: xadc_fpro.sh [-step]\n\
Usage: xadc_fpro.sh [-lib_map_path]\n\
Usage: xadc_fpro.sh [-reset_run]\n\
Usage: xadc_fpro.sh [-reset_log]\n\
Usage: xadc_fpro.sh [-keep_index]\n\
